...
## ----detect1, warning=FALSE, message=FALSE, fig.width=4, fig.cap="Figure 7: The detection functions for males and females."----
...
## ----detect2, warning=FALSE, message=FALSE, fig.width=4, fig.cap="Figure 8: The detection functions for males and females."----
...
## ----transects, warning=FALSE, message=FALSE, echo = FALSE, fig.width=4, fig.cap="Figure 9: Example survey transects."----
...
## ----check.sim2, fig.height=5.5, fig.width=7.2, fig.cap="Figure 11: Example survey."----
...
## ----makeplots, eval= TRUE, echo = FALSE, fig.width=7.2, fig.cap="Figure 13: Histograms of the parameter estimates for sigma and sex.male for three of the five truncation distances investigated."----
