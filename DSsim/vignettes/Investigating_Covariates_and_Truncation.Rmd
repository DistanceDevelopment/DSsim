...
density <- make.density(region.obj = region, x.space = 100, y.space = 200, constant = 1)
# The plot function allows plotting in km or m.
...
```{r popdesc, warning=FALSE, message=FALSE, fig.width=4, fig.cap="Figure 6: The density surface."}
