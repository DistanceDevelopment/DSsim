...
```{r loadresults, eval = TRUE, echo = FALSE}

# Simulations using a simple half normal detection function
data(trunc_summary)
summary.t200 <- summary.list[[1]]
summary.t400 <- summary.list[[2]]
summary.t600 <- summary.list[[3]]

# Covartiate simulations
data(trunc_cov_summary)
summary.cov.t200 <- cov.summary.list[[1]]
summary.cov.t400 <- cov.summary.list[[2]]
summary.cov.t600 <- cov.summary.list[[3]]
summary.cov.t800 <- cov.summary.list[[2]]
summary.cov.t1000 <- cov.summary.list[[3]]
